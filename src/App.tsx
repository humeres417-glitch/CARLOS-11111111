  ...
  function createNewDefaultInspection(): Inspection {
    ...
    return {
      ...
      technical: {
        ...
        installedPowerKwp: '5.0',
        inverterBrandModel: '',
        inverterSerialNumber: '',
        panelsCountAndPower: '10x 550W',
        structureType: 'Coplanar',
        roofType: 'Zinc 5V / PV4 (Trapezoidal)',
        customStructureNote: '',
        mpptCount: '2 MPPT',
      ...
      generalNotes: 'La instalación fotovoltaica ha sido ejecutada conforme a la reglamentación técnica vigente de la SEC para la tramitación de la Declaración TE4.',
      status: 'Borrador',
    };
  }
